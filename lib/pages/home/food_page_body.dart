  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
          ...
          builder: (popularProducts) {
            return new DotsIndicator(
              ...
              decorator: DotsDecorator(
                activeColor: AppColors.themeColor1,
        ...
        GetBuilder<PromotionProductController>(
          builder: (promotionProduct) {
            return promotionProduct.isLoaded
                ? ListView.builder(
                    physics: NeverScrollableScrollPhysics(),
                    shrinkWrap: true,
                    itemCount: promotionProduct.recommendedProductList.length,
                ...
                : CircularProgressIndicator(color: AppColors.themeColor1);
          },
        )
      ],
    );
